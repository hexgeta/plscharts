...
import { VisualizationSettings, SphereType } from '@/components/VisualizationSphere';
import {
  MAXI_SPHERE_CONFIG,
  DECI_SPHERE_CONFIG,
  LUCKY_SPHERE_CONFIG,
  TRIO_SPHERE_CONFIG,
  BASE_SPHERE_CONFIG
} from '@/components/sphereConfigs';

const VisualizationSphere = dynamic(() => import('@/components/VisualizationSphere'), {
  ssr: false,

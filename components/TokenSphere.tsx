...
export default function TokenSphere({ 
  ...
  useEffect(() => {
    if (!mountRef.current || !startAnimation || isLoading || !yieldData || yieldData.length === 0) return;
    ...
    const availableDays = yieldData.length;
  ...
  }, [settings, startAnimation, isLoading, yieldData]);

  return (
    <div className="w-full h-full relative">
      <div className={`w-full h-full transition-opacity duration-1000 ${startAnimation ? 'opacity-100' : 'opacity-0'}`}>

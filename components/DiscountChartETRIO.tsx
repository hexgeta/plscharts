...
import { CumBackingValueETRIO } from '@/hooks/CumBackingValueETRIO';
...
function DiscountChartETRIO({ title }: Props) {
  const { data, error, isLoading } = CumBackingValueETRIO();
...
export default DiscountChartETRIO; 
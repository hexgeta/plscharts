...
import { CumBackingValueEDECI } from '@/hooks/CumBackingValueEDECI';

interface Props {
  title: string;
}

function DiscountChartEDECI({ title }: Props) {
  const { data, error, isLoading } = CumBackingValueEDECI();
...
export default DiscountChartEDECI; 
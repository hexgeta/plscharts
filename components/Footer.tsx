...
const Footer = () => {
  return (
    <footer className="w-full bg-black px-4 py-8 border-t border-[rgba(255,255,255,0.2)] relative z-[100] mb-[90px] sm:mb-0">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="text-sm space-y-1">
            ...
            <li><a href="/portfolio" className="text-[rgb(153,153,153)] hover:text-gray-300">Portfolio</a></li>

...
export function TopStats() {
  ...
  useEffect(() => {
    ...
    if (!pricesLoading && gasPrice !== undefined) {
  ...
  }, [pricesLoading, gasPrice, isAnimating]);
  ...
  const LoadingSkeleton = () => (
    <motion.div 
      ...
      className="w-full max-w-[95vw] mx-auto relative"
    >
    ...
    <AnimatePresence mode="wait">
      {isLoading ? (
        ...
        <motion.div
          ...
          className="w-full max-w-[95vw] mx-auto rounded-xl p-4 bg-black/5 backdrop-blur-sm border-2 border-white/10 h-auto relative"
        >
            ...
            <table className="w-full min-w-[1400px]">
              ...
              <tbody>
                {tokens.map((baseToken) => {
                  ...
                  const { backingData } = useBackingValue(token);

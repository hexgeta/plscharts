...
// Modified constants for TRIO
const LINEAR_SLOPE_MULTIPLIER = 1;    // Adjusted for TRIO
...
function ProjectionChartTRIO({ 
  tableName = 'pTRIO - DiscountChart',
  title = 'pTRIO 🎲', 
  xAxisKey = 'Day', 
...
export default ProjectionChartTRIO;
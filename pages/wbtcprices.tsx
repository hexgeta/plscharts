...
import LiveWbtcPrice from '@/components/LiveWbtcPrice';

const playlist = [
  '1.mp3'
];

export default function WbtcLivestream() {
      ...
      {!hasEntered && (
        <div className="fixed inset-0 bg-black z-50 flex flex-col items-center justify-center gap-4">
          <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4 text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">WBTC Live Price Radio™</h1>
